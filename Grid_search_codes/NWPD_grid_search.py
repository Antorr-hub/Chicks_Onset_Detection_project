...
threshold_range = [0.8, 0.92, 0.95]   #threshold=0.92, smooth=None, pre_avg=0, post_avg=0, pre_max=30, post_max=30)
pre_avg_range =[0, 1, 10]
post_avg_range =[0, 1, 10]
pre_max_range = [20, 30, 50]
post_max_range = [20, 30, 50]
